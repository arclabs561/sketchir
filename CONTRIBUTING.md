# Contributing to sketchir

Thanks for your interest. sketchir is sketching primitives for IR: minhash/simhash/LSH-style signatures.
...
- Commit messages: `sketchir: short lowercase description`. One commit per logical change.
